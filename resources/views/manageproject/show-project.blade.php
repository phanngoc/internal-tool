        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="col-md-8 col-md-offset-2">
                {!! Form::open([
                  'route' => [ 'manageproject.updateProject', $project->id ],
                  'method' => 'POST',
                  'class' => 'edit'
                    ])
                !!}
                ...
                <div class="form-group">
                  ...
                  {!! Form::text('projectname', $project->projectname, [ 'id' => 'projectname', 'class' => 'form-control','autofocus']) !!}
                ...
                <div class="form-group">
                  ...
                  {!! Form::textarea('description',$project->description,['id'=>'description', 'class'=>'form-control']) !!}
                </div>
