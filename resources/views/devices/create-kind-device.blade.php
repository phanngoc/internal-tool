            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">{{trans('messages.add_kind_device')}}</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('device_name',null,['id'=>'device_name','class'=>'form-control','placeholder'=>trans('messages.device_name')]) !!}
                        </div>
                        <div class="form-group">
                            {!! HTML::decode(Form::label('quantity',trans('messages.quantity').' <span id="label">*</span>')) !!}
                            {!! Form::text('quantity',null,['id'=>'quantity','class'=>'form-control','placeholder'=>trans('messages.quantity')]) !!}
                        </div>
                        <div class="form-group">
                            {!! HTML::decode(Form::label('type_id',trans('messages.typeDevices').' <span id="label">*</span>')) !!}
                            {!! Form::select('type_id',$typeDevices,null, ['class'=>'js-example-basic-multiple form-control','required'=>'true']) !!}
                        </div>
