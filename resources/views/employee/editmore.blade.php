                      ...
                      <div class="inner row">
                         <div class="col-md-12">
                          ...
                          <div id="area-add-project" class="box box-info">
                            <div class="box-header">
                              <div class="box-tools pull-right">
                                <button class="btn btn-box-tool addProject" title="Add new project"><i class="fa fa-plus text-green"></i></button>
                                <button class="btn btn-box-tool removeProject" title="Remove project"><i class="fa fa-remove text-red"></i></button>
                              </div>
                            </div>
                            <div class="box-body">
                              <div class="col-md-6">
