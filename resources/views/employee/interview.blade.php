                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Date Interview</th>
                                    <th class="text-center">Time Interview</th>
                            ...
                            <tbody>
                                <?php
                                  ...
                                  <tr>
                                    ...
                                    <td><p style="display:none">{{ $value->time_interview }}</p> <input value="{{ $value->time_interview }}" class="time_interview"/></td>
                                    <td><input value="{{ $value->time }}" class="ui-timepicker-input time" type="text" /></td>
                                        ...
                                        <i class="fa fa-fw fa-floppy-o"></i>
                                            ...
                                            <?php 
                                              ...
                                              foreach ($files as $k_f => $v_f) {
                                                if(strpos($v_f->name,'ASIANTECH_CV') !== false)
                                                {
                                                  echo '<a href="download/'.$v_f->name.'"><i class="fa fa-download"></i></a>';
                                                }
                                              }
                                            ?>
