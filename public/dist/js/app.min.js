...
//var menuStateAry = "123";
//alert(menuStateAry);
//$('li').eq(menuStateAry).addClass('active');
$('ul.sidebar-menu li.treeview').click(function() {
	//UpdateUserCookie($(this).index());
	var slideIndex = $(this).index('.treeview');
	//alert($(this).index()+"-"+slideIndex);
...
{
	//alert("1-"+(vitrimenu));
	//$('li').eq(1).addClass("menu-open");
	//$('ul.sidebar-menu li ul').eq(1).addClass("menu-open");
...
//UpdateUserCookie($('li.active').index())
//UpdateUserCookie($('li.active.treeview').index());
}
)}
...
,$.AdminLTE.boxWidget={
selectors:$.AdminLTE.options.boxWidgetOptions.boxWidgetSelectors,icons:$.AdminLTE.options.boxWidgetOptions.boxWidgetIcons,activate:function(){
var a=this;
